...
public class ViewHolderManageBooking extends RecyclerView.ViewHolder {
    ...
    public ViewHolderManageBooking(View itemView) {
        super(itemView);
        ...
        btnCalendar = (Button) itemView.findViewById(R.id.btn_calendar);
    }
    ...
    public Button getBtnCalendar() {
        return btnCalendar;
    }

    public void setBtnCalendar(Button btnCalendar) {
