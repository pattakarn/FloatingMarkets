...
public class ViewHolderManageTravel extends RecyclerView.ViewHolder {
    ...
    public ViewHolderManageTravel(View itemView) {
        super(itemView);
    ...
    public TextView getTvTravel() {
        return tvTravel;
    }

    public void setTvTravel(TextView tvTravel) {
