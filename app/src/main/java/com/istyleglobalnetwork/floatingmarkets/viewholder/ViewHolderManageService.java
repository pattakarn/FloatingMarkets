...
public class ViewHolderManageService extends RecyclerView.ViewHolder {
    ...
    public ViewHolderManageService(View itemView) {
        super(itemView);
    ...
    public void setTvService(TextView tvService) {
