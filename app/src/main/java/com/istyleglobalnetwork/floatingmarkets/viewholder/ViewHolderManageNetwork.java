...
public class ViewHolderManageNetwork extends RecyclerView.ViewHolder {
    ...
    public ViewHolderManageNetwork(View itemView) {
        super(itemView);
        cv = (CardView) itemView.findViewById(R.id.cv);
        tvNetwork = (TextView) itemView.findViewById(R.id.tv_network);
    ...
    public void setTvNetwork(TextView tvNetwork) {
