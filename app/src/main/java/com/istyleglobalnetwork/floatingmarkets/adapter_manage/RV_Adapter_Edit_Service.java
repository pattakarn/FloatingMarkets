...
import com.istyleglobalnetwork.floatingmarkets.DialogPopup.DialogManageService;
...
import com.istyleglobalnetwork.floatingmarkets.viewholder.ViewHolderEditServiceData;
...
public class RV_Adapter_Edit_Service extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RV_Adapter_Edit_Service(List<Object> items) {
        this.items = items;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                ...
                break;
            case 1:
                View v2 = inflater.inflate(R.layout.card_edit_service_data, parent, false);
                viewHolder = new ViewHolderEditServiceData(v2);
                break;
            case 2:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            case 0:
                ...
                configureViewHolderEditServiceHead(vh1, position);
                break;
            case 1:
                ViewHolderEditServiceData vh2 = (ViewHolderEditServiceData) holder;
                configureViewHolderEditServiceData(vh2, position);
                break;
            case 2:
                ViewHolderEditShopAward vh3 = (ViewHolderEditShopAward) holder;
                configureViewHolderEditServiceAward(vh3, position);
                break;
            case 3:
                ViewHolderEditShopOpentime vh4 = (ViewHolderEditShopOpentime) holder;
                configureViewHolderEditServiceOpentime(vh4, position);
                break;
            case 4:
...
//                configureViewHolderEditProductPhoto(vh, position);
    ...
    private void configureViewHolderEditServiceHead(ViewHolderEditZoneHead vh1, int position) {
    ...
    private void configureViewHolderEditServiceData(ViewHolderEditServiceData vh1, int position) {

        ArrayList<Object> tempObject = (ArrayList<Object>) items.get(position);
        final WrapFdbService dataService = (WrapFdbService) tempObject.get(0);
        ...
        vh1.getColName().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeText(dataService, dataMarket, "name");
            }
        });
        vh1.getColOwner().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeText(dataService, dataMarket, "owner");
            }
        });
        vh1.getColPhone().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeText(dataService, dataMarket, "phone");
            }
        });
        vh1.getColLine().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeText(dataService, dataMarket, "line");
            }
        });
        vh1.getColFacebook().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeText(dataService, dataMarket, "facebook");
            }
        });
        vh1.getColEmail().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeText(dataService, dataMarket, "email");
            }
        });
        ...
        if (dataService.getData() != null) {
            vh1.getColName().getTvValue().setText(dataService.getData().getNameService());
            vh1.getColOwner().getTvValue().setText(dataService.getData().getOwner());
            vh1.getColPhone().getTvValue().setText(dataService.getData().getPhone());
            vh1.getColLine().getTvValue().setText(dataService.getData().getLine());
            vh1.getColFacebook().getTvValue().setText(dataService.getData().getFacebook());
            vh1.getColEmail().getTvValue().setText(dataService.getData().getEmail());
        }


    }

    private void configureViewHolderEditServiceAward(ViewHolderEditShopAward vh3, int position) {
        ArrayList<Object> tempObject = (ArrayList<Object>) items.get(position);
        final WrapFdbService dataService = (WrapFdbService) tempObject.get(0);
        ...
        vh3.getColAward1().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                if (dataAward.size() > 0) {
                    popup.Popup_ChangeAward(dataService, dataAward.get(0), "award1");
                } else {
                    popup.Popup_ChangeAward(dataService, null, "award1");
                }
            }
        });
        vh3.getColAward2().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                if (dataAward.size() > 1) {
                    popup.Popup_ChangeAward(dataService, dataAward.get(1), "award2");
                } else {
                    popup.Popup_ChangeAward(dataService, null, "award2");
                }
            }
        });
        vh3.getColAward3().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                if (dataAward.size() > 2) {
                    popup.Popup_ChangeAward(dataService, dataAward.get(2), "award3");
                } else {
                    popup.Popup_ChangeAward(dataService, null, "award3");
                }
            }
        });
    ...
    private void configureViewHolderEditServiceOpentime(ViewHolderEditShopOpentime vh1, int position) {
        ...
        vh1.getColMonday().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeOpentime(dataService, dataMarket, "monday");
            }
        });
        vh1.getColTuesday().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeOpentime(dataService, dataMarket, "tuesday");
            }
        });
        vh1.getColWednesday().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeOpentime(dataService, dataMarket, "wednesday");
            }
        });
        vh1.getColThursday().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeOpentime(dataService, dataMarket, "thursday");
            }
        });
        vh1.getColFriday().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeOpentime(dataService, dataMarket, "friday");
            }
        });
        vh1.getColSaturday().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeOpentime(dataService, dataMarket, "saturday");
            }
        });
        vh1.getColSunday().getLl().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManageService popup = new DialogManageService(inflater.getContext());
                popup.Popup_ChangeOpentime(dataService, dataMarket, "sunday");
            }
        });
        ...
        if (dataService.getData() != null) {
            vh1.getColMonday().getTvValue().setText(dataService.getData().getMonday());
            vh1.getColTuesday().getTvValue().setText(dataService.getData().getTuesday());
            vh1.getColWednesday().getTvValue().setText(dataService.getData().getWednesday());
            vh1.getColThursday().getTvValue().setText(dataService.getData().getThursday());
            vh1.getColFriday().getTvValue().setText(dataService.getData().getFriday());
            vh1.getColSaturday().getTvValue().setText(dataService.getData().getSaturday());
            vh1.getColSunday().getTvValue().setText(dataService.getData().getSunday());
        }
